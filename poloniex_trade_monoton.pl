...
my $max_average_deviation = 2; # the procent of maximum average deviation that we allow
my $max_dev_size = 0.4; # the maximum procent of deviation of the current price to the middle of the average
